...
public class GameConstant {
	...
	// error Messages
	public static final String PLAYER_COUNT_ERROR = new String("Enter a valid Number-Players count should be between 2 and 6");
	public static final String INVALID_PLAYER_COUNT_ERROR = new String("Please Enter a valid player count between 2 to 6");
